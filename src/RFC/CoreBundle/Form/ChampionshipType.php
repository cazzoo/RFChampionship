	...
	public function buildForm(FormBuilderInterface $builder, array $options) {
		...
		$builder->add ( 'name' )->add ( 'description', 'textarea', array (
				...
				'query_builder' => function (MetaRuleRepository $mr) use($gameId) {
					return $mr->createQueryBuilder ( 'm' )->where ( 'm.game = :gameId' )->setParameter ( 'gameId', $gameId );
				} 
				...
				'query_builder' => function (RuleRepository $er) use($gameId) {
					return $er->createQueryBuilder ( 'r' )->where ( 'r.game = :gameId' )->setParameter ( 'gameId', $gameId );
				} 
