...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('RFCCoreBundle:Game:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RFCCoreBundle:Game:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        return $this->render('RFCCoreBundle:Game:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RFCCoreBundle:Game:edit.html.twig', array(
            'entity'      => $entity,
