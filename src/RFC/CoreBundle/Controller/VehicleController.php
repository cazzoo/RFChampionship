...
class VehicleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RFCCoreBundle:Vehicle')->findAll();

        return $this->render('RFCCoreBundle:Vehicle:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_vehicle_show', array('id' => $entity->getId())));
        }

        return $this->render('RFCCoreBundle:Vehicle:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Vehicle $entity)
    {
        $form = $this->createForm(new VehicleType(), $entity, array(
            'action' => $this->generateUrl('admin_vehicle_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('RFCCoreBundle:Vehicle:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RFCCoreBundle:Vehicle:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new VehicleType(), $entity, array(
            'action' => $this->generateUrl('admin_vehicle_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_vehicle_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_vehicle'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_vehicle_delete', array('id' => $id)))
            ->setMethod('DELETE')
