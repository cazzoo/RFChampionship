...
class ResultController extends RFCController
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('RFCAdminBundle:Result:index.html.twig',
                array(
                'entities' => $entities
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_result_show',
                        array(
                        'resultId' => $entity->getId()
            )));
        }

        return $this->render('RFCAdminBundle:Result:new.html.twig',
                array(
                'entity' => $entity,
    ...
    public function showAction($resultId)
    {
        ...
        return $this->render('RFCAdminBundle:Result:show.html.twig',
                array(
                'entity' => $entity,
    ...
    public function editAction($resultId)
    {
        ...
        return $this->render('RFCAdminBundle:Result:edit.html.twig',
                array(
                'entity' => $entity,
    ...
    private function createEditForm(Result $entity)
    {
        $form = $this->createForm(new ResultType(), $entity,
            array(
            'action' => $this->generateUrl('admin_result_update',
                array(
                'resultId' => $entity->getId()
            )),
            'method' => 'PUT'
    ...
    public function updateAction(Request $request, $resultId)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_result_edit',
                        array(
                        'resultId' => $resultId
            )));
        }
    ...
    {
        return $this->createFormBuilder()->setAction($this->generateUrl('admin_result_delete',
                    array(
                    'resultId' => $resultId
    ...
    public function setSessionResultsAction()
    {
        ...
        $session = $entityManager->getRepository("RFCCoreBundle:Session")->findOneBy(array(
