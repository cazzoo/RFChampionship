...
class SubStepController extends RFCController
{
    ...
    public function createAction(Request $request, $gameId, $stepId)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('setup_step_index',
                        array(
                        'gameId' => $gameId
            )));
        }

        return $this->render('RFCSetupBundle:SubStep:new.html.twig',
                array(
                'entity' => $entity,
    ...
    public function editAction($subStepId, $stepId, $gameId)
    {
        ...
        return $this->render('RFCSetupBundle:SubStep:edit.html.twig',
                array(
                'entity' => $entity,
                'stepId' => $stepId,
                'gameId' => $gameId,
    ...
    public function updateAction(Request $request, $subStepId, $stepId, $gameId)
    {
        ...
        return $this->render('RFCSetupBundle:Step:edit.html.twig',
                array(
                'entity' => $entity,
                'edit_form' => $editForm->createView(),
                'delete_form' => $deleteForm->createView(),
     ...
     */
    public function deleteAction($subStepId, $gameId)
    {
        $entityManager = $this->getDoctrine()->getManager();
        $entity        = $entityManager->getRepository('RFCSetupBundle:SubStep')->find($subStepId);
    ...
    {
        $form = $this->createForm(new SubStepType(), $entity,
            array(
            'em' => $this->getDoctrine()->getManager(),
            'action' => $this->generateUrl('setup_subStep_create',
                array(
                'stepId' => $stepId,
                'gameId' => $gameId
            )),
    ...
    {
        return $this->createFormBuilder()->setAction($this->generateUrl('setup_subStep_delete',
                    array(
                    'stepId' => $stepId,
                    'subStepId' => $subStepId,
                    'gameId' => $gameId
    ...
    private function createEditForm(SubStep $entity, $stepId, $gameId)
    {
        $form = $this->createForm(new SubStepType(), $entity,
            array(
            'em' => $this->getDoctrine()->getManager(),
            'action' => $this->generateUrl('setup_subStep_update',
                array(
                'stepId' => $stepId,
